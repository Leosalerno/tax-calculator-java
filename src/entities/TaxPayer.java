...
public class TaxPayer {
	...
	public double salaryTax() {
		if ((salaryIncome/12.0) < 3000.0) {
			return 0.0;
		}
		else if ((salaryIncome/12.0) < 5000.0) {
	...
	public double taxRebate() {
		if ((healthSpending + educationSpending) > (servicesTax() + capitalTax() + salaryTax())*0.3) {
			return (servicesTax() + capitalTax() + salaryTax()) * 0.3;
		}
		else {
